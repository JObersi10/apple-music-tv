...
- **5 draw calls per frame** (4 blobs + 1 center darken) — do not exceed 4 blobs
- **`BlendMode.Screen` costs an offscreen compositing pass per draw** — 6 blobs caused lag on Fire TV; 4 is the ceiling

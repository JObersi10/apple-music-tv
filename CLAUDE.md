...
- Endpoints: `GET /`, `GET /status`, `GET /logs`, `GET /netlogs`, `POST /set-token`, `POST /clear-token`, `POST /set-lyrics-offset`, `POST /set-beat-latency`, `POST /set-crossfade`
